...
int main() {
    ...
    user* u1 = new user(93, "Saira", "saira.345@gmail.com", "US", "Silver");
    user* u2 = new user(42, "Ali", "ali.895@gmail.com", "US", "Platinum");
    user* u3 = new user(98, "Affan", "affaan.235@gmail.com", "US", "Silver");
    user* u4 = new user(25, "Reham", "reham.754@gmail.com", "UK", "Gold");
    user* u5 = new user(77, "Sarim", "sarim.546@gmail.com", "Zambia", "Platinum");
    ...
    cout << "\n ---creating group index on type--- \n";
    list_of_user.create_type_group_index();
    cout << "\n----------------------------- \n";


    cout << "\n--- listing users of Country(UK)---\n";
    list_of_user.list_users_by_country("UK");

    cout << "\n\n ---listing users of type(silver)---\n";
    list_of_user.list_users_by_type("Silver");
    cout << "\n----------------------------- \n";


    cout << "\n--- displaying group index created on country---  \n";
    list_of_user.display_country_group_index();
    cout << "\n----------------------------- \n";

    cout << "\n\n--- displaying group index created on type --- \n";
    list_of_user.display_type_group_index();
    cout << "\n----------------------------- \n";

    cout << "\n ---deleting group index on country--- \n";
    list_of_user.delete_country_group_index();
    cout << "\n--- deleting group index on type---  \n";
    list_of_user.delete_type_group_index();
    cout << "\n----------------------------- \n";
